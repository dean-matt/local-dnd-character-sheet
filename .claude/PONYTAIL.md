...
Baseline coding disposition for this repo. Reproduced verbatim from
[github.com/DietrichGebert/ponytail](https://github.com/DietrichGebert/ponytail) (MIT) — binding;
do not reword, soften, or trim it.
...
Output: code first, then at most three short lines: what was skipped, when
to add it. If the explanation is longer than the code, delete the
explanation.

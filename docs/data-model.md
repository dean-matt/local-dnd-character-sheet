...
A character stores the full one, because it names a row rather than a join — the level's
own class carries the other two parts, and the short name keys no row.
